    ...
    case 'reverse_settlement_atomic': {
      ...
      if (settlement) {
        fakeDb.settlements.set(settlementId, {
          ...settlement,
          status: 'reversed',
          notes: (settlement.notes || '') + ' [REVERSED: ' + reason + ']',
          updated_at: new Date().toISOString()
        });
      }
...
test('P1B: all 6 RPC names are registered and callable', async () => {
  ...
  const testCalls = [
    { fn: 'record_transaction_atomic', params: { p_request_id: 'r1', p_transaction: { id: 't1', direction: 'income', category: 'test', amount: 1, currency: 'EGP', fx_rate: 1, amount_egp: 1, transaction_date: '2026-01-01' } } },
    ...
    { fn: 'record_settlement_atomic', params: { p_request_id: 'r4', p_settlement: { id: 's1', obligation_id: 'o1', amount_egp: 1, payment_method: 'cash', settlement_date: '2026-01-01' }, p_allocations: [] } },
    { fn: 'reverse_settlement_atomic', params: { p_request_id: 'r5', p_settlement_id: 's1', p_reason: 'test' } },
    { fn: 'record_stock_adjustment_atomic', params: { p_request_id: 'r6', p_adjustment: { id: 'adj1', asset_id: 'a1', project_id: 'p1', adjustment_date: '2026-01-01', reason: 'other', quantity_delta: 1, unit: 'piece' } } }
  ];
