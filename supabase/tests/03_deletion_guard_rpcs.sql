...
delete from public.settlement_allocations; delete from public.settlements;
delete from public.obligations; delete from public.operational_events;
delete from public.stock_adjustments; delete from public.transactions;
delete from public.documents; delete from public.project_partners;
delete from public.assets; delete from public.partners; delete from public.projects;
