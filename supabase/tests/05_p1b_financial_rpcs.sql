...
values (public.terranex_test_uuid(2), '11111111-1111-4111-8111-111111111111', 'شريك اختبار', 'counterparty')
on conflict do nothing;
...
insert into public.partners (id, owner_id, name_ar, category)
values (public.terranex_test_uuid(11), '22222222-2222-4222-8222-222222222222', 'شريك', 'counterparty')
on conflict do nothing;
...
insert into public.partners (id, owner_id, name_ar, category)
values (public.terranex_test_uuid(21), '33333333-3333-4333-8333-333333333333', 'شريك', 'counterparty')
on conflict do nothing;
...
insert into public.settlements (id, owner_id, obligation_id, amount_egp, payment_method, settlement_date, status, origin)
values (public.terranex_test_uuid(23), '33333333-3333-4333-8333-333333333333', public.terranex_test_uuid(22), 400, 'cash', '2026-07-20', 'active', 'user');
...
insert into public.assets (id, owner_id, project_id, name_ar, asset_type, status, acquisition_date, acquisition_cost_egp)
values (public.terranex_test_uuid(31), '44444444-4444-4444-8444-444444444444', public.terranex_test_uuid(30), 'أصل', 'equipment', 'owned', '2026-01-01', 10000);
