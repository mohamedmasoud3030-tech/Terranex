-- Migration: extend record_settlement_atomic to accept bank_account_id.
-- Date: 2026-08-02
...
begin
  ...
  v_bank_account := nullif(p_settlement->>'bank_account_id', '')::uuid;
  ...
  insert into public.settlements (
    id, owner_id, obligation_id, bank_account_id,
    amount, currency, fx_rate, amount_egp,
