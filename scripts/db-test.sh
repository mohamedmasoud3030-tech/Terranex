...
#  13. round-trip   — forward -> rollback -> reapply, ending in a working schema
#  14. idempotency  — re-application onto existing schema without drop or error
#
...
note "14/14  IDEMPOTENCY GATE — re-applying all migrations on top of existing schema"
apply_forward
