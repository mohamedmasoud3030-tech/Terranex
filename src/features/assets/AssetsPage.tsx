      ...
      <div className="grid gap-3 sm:grid-cols-3">
        <Card>
          <CardContent>
            ...
            <p className="mt-2 text-xl font-bold sm:text-2xl">{assets.length}</p>
          </CardContent>
        </Card>
        <Card>
          <CardContent>
            <p className="text-sm text-muted-foreground">تكلفة الاقتناء</p>
            <p className="mt-2 text-xl font-bold sm:text-2xl">{formatEgp(totalAcquisition, true)} EGP</p>
          </CardContent>
        </Card>
        <Card>
          <CardContent>
            <p className="text-sm text-muted-foreground">القيمة الحالية</p>
            <p className="mt-2 text-xl font-bold text-primary sm:text-2xl">{formatEgp(totalCurrentValue, true)} EGP</p>
          </CardContent>
        </Card>
      </div>
