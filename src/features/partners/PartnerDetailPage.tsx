      ...
      <div className="grid gap-3 sm:grid-cols-3">
        <Card>
          <CardContent>
            ...
            <p className="mt-2 text-xl font-bold text-success sm:text-2xl">{formatEgp(receivable, true)} EGP</p>
          </CardContent>
        </Card>
        <Card>
          <CardContent>
            <p className="text-sm text-muted-foreground">ندين له</p>
            <p className="mt-2 text-xl font-bold text-danger sm:text-2xl">{formatEgp(payable, true)} EGP</p>
          </CardContent>
        </Card>
        <Card>
          <CardContent>
            <p className="text-sm text-muted-foreground">صافي العلاقة</p>
            <p className={`mt-2 text-xl font-bold sm:text-2xl ${receivable - payable >= 0 ? 'text-success' : 'text-danger'}`}>
