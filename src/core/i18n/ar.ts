...
export const ar = {
  ...
  // Agriculture page
  ag_new_season: 'موسم جديد',
  ag_new_project: 'موسم / مشروع زراعي جديد',
  ag_metric_sales: 'إجمالي المبيعات',
  ag_metric_costs: 'تكاليف المواسم',
  ag_metric_profit: 'ربحية الموسم',
  ag_farms_section: 'المزارع والأراضي',
  ag_seasons_section: 'المواسم',
  ag_income_label: 'إيرادات',
  ag_costs_label: 'تكاليف',
  ag_empty_title: 'لا توجد بيانات بعد',
  ag_empty_desc: 'أضف أول موسم زراعي لتبدأ تتبع الإنتاج والربحية.',

  // Livestock page
  lv_new_herd: 'قطيع جديد',
  lv_new_project: 'قطيع / مشروع حيواني جديد',
  lv_metric_heads: 'إجمالي الرؤوس',
  lv_metric_revenue: 'إيرادات البيع',
  lv_metric_care: 'تكاليف الرعاية',
  lv_metric_profit: 'صافي الربح',
  lv_herds_section: 'القطعان والأصول',
  lv_projects_section: 'مشاريع القطعان',
  lv_heads_unit: 'رأس',
  lv_cost_label: 'تكلفة',
  lv_empty_title: 'لا توجد بيانات بعد',
  lv_empty_desc: 'أضف أول مشروع حيواني لتبدأ تتبع القطعان والمبيعات.',
